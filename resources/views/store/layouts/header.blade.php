    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        @else
          ...
          <!--uso o mailtrap.io
            vou em config/mail.php e coloco o email e nome e depois no arquivo env. modifico as variavei de email e também no próprio env. coloco a real url no APP_URL=http://pagseguro.test/
          -->
        @endif
      </ul>
    </div><!-- /.navbar-collapse -->
